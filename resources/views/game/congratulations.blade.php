    ...
    <div class="halo_intro_info">
        ...
        <div class="upload_avtar margintop30">
            ...
            <div class="icon icon1">
                <p data-aos="fade-down" data-aos-delay="1500">Excellence</p> <br />
                <svg id="Layer_1" data-name="Layer 1" fill="none" stroke="black" stroke-width="1"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110.06 48.5">
                    <path
                    ...
                    <path d="M669.43,540.38v0s0,0,0,0C669.4,540.26,669.4,540.26,669.43,540.38Z"
                        transform="translate(-561.57 -515.1)" /></svg>

            </div>

            <div class="icon icon2">
                <p data-aos="fade-down" data-aos-delay="1500">Innovative <br /> thinking</p> <br />
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114.18 89.45">
                    <path
                        ...
                        transform="translate(-559.08 -494.72)" /></svg>
            </div>

            <div class="icon icon3">
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 71.59 87.05">
                    <path
                        ...
                        transform="translate(-580.55 -496.06)" /></svg>
                <br />
                <p data-aos="fade-up" data-aos-delay="1500">Collaboration</p>
            </div>

            <div class="icon icon4">
                <p data-aos="fade-down" data-aos-delay="1500">Integrity</p> <br />
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 73.95 40.95">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #020202;
            ...
            <div class="icon icon5">
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55.31 80.6">
                    <path
                        ...
                        transform="translate(-578.89 -499.25)" /></svg> <br />
                <p data-aos="fade-up" data-aos-delay="1500">Empathy</p>
            </div>

            <div class="icon icon6">
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 83.09 89.41">
                    <path
                    ...
                    <path d="M649.89,584l-.29.17s.08,0,.11,0Z" transform="translate(-574.61 -494.88)" />
                    <path d="M649.6,584.18s0,0-.05,0-.06.09-.13.1Z" transform="translate(-574.61 -494.88)" />
                    <path d="M648.38,584s.1,0,.14,0l-.24-.24A2.14,2.14,0,0,1,648.38,584Z"
                        transform="translate(-574.61 -494.88)" />
                    <path d="M648.65,584.16s-.06-.1-.11-.14h0Z" transform="translate(-574.61 -494.88)" /></svg> <br />
                <p data-aos="fade-up" data-aos-delay="1500">Value creation</p>
            </div>
            <a class="custom-button custom-button-share" href="#"><span>Share</span></a>
        </div>
    </div>
</div>
@endsection
